...
/* @modified by zhangwei on 2012.04.17
 * - the macro chip should be defined through IAR workbench project manager.  So that
 *   we can switch the low level transceiver chip earily. I defined it here in order
 *   to make the porting of "components" library easily only.
 */ 
#define chip 2430
