...
/* @attention
 * For IAR Compiler for 8051
 * the pack data alighment indicateor is no use. 
 *
 * For other compilers such as Keil and GNUC(such as WinAVR)
 * You MUST use the following to control the data alignment
 *    #pragma pack(1) 
 */  
