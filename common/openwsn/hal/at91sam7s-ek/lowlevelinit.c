This function, developed by Atmel Technical Support, initializes the PLL clock system. Some annotation 
has been extended by the author.
...
// The following functions must be write in ARM mode this function called di
// by exception vector 
