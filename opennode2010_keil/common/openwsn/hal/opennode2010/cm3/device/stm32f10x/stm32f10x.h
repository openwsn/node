 ...
 * - ZhangWei choose STM32F10X_MD in the following configuratioins. Though this 
 *   objective can be achieved by setting the compiler parameters, But i still prefer
 *   to modify this file. It should be easier for beginners.
 */ 
