The isrsupport module is adapted from an example posted to the Yahoo LPC2000 user¡¯s group by Bill 
Knight and contains various utility functions to enable/disable interrupts, etc.
