...
#define CR1_CLEAR_Mask_USART            ((u16)0xE9F3)  /* USART CR1 Mask */
...
#define CR3_CLEAR_Mask_USART            ((u16)0xFCFF)  /* USART CR3 Mask */
