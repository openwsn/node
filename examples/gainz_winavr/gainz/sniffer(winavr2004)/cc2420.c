...
{
    uint8_t num,i,time,flag;
	uint8_t count=0;
	uint8_t *cc2420_buf_print;
	...
	cc2420_buf_print=malloc(256);
	cc2420_buf_print[count++]=0x8e;
	for(i=0;i<num;i++,count++)
	{
		switch(cc2420_rxbuf_now[i])
		{
			case 0x7e:
				cc2420_buf_print[count++]=0x7d;
				cc2420_buf_print[count]=0x5e;
				break;
			case 0x7d:
				cc2420_buf_print[count++]=0x7d;
				cc2420_buf_print[count]=0x5d;
				break;
			case 0x8e:
				cc2420_buf_print[count++]=0x8d;
				cc2420_buf_print[count]=0x6e;
				break;
			case 0x8d:
				cc2420_buf_print[count++]=0x8d;
				cc2420_buf_print[count]=0x6d;
				break;
			default:
				cc2420_buf_print[count]=cc2420_rxbuf_now[i];
				break;
		}
	}
	cc2420_buf_print[count]=0x7e;
	for(i=0;i<count+1;i++)
		usart_putbyte(cc2420_buf_print[i]);
	free(cc2420_buf_print);
