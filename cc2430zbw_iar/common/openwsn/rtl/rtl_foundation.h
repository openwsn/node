...
/**
 * @modified by zhangwei on 2012.01.10
 * - IAR workbench doesn't provide <stdint.h>. So i had to comment it and the whole
 *   software package depends on the types defined in "configall.h"
 */
