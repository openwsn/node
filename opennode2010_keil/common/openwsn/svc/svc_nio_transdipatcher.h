 ...
 *
 ******************************************************************************/
#ifndef _SVC_NIO_TRANSDISPATCHER_H_8496_
#define _SVC_NIO_TRANSDISPATCHER_H_8496_
...
#ifndef CONFIG_NIO_TRANSLAYER_DISP_CAPACITY 
#define CONFIG_NIO_TRANSLAYER_DISP_CAPACITY 4
#endif

#define MAX_IEEE802FRAME154_SIZE FRAME154_MAX_FRAME_LENGTH
#define NIO_TRANSDISPA_FRAME_MEMSIZE FRAME_HOPESIZE(MAX_IEEE802FRAME154_SIZE)


#define NIO_TRANSDISPA_HOPESIZE(capacity) (sizeof(TiNioTransLayerDispatcher) + sizeof(_TiNioTransLayerDispatcherItem)*capacity)
...
typedef struct{
    ...
    uint8 proto_id;
}_TiNioTransLayerDispatcherItem;
...
typedef struct{
    ...
    TiFrame * fwbuf;
    TiNodeBase * nbase;
	TiNioNetLayerDispatcher *netdispa;
    //TiAloha * mac;
    char rxbuf_memory[NIO_TRANSDISPA_FRAME_MEMSIZE];
    char fwbuf_memory[NIO_TRANSDISPA_FRAME_MEMSIZE];
    char txbak_memory[NIO_TRANSDISPA_FRAME_MEMSIZE];
    _TiNioTransLayerDispatcherItem items[CONFIG_NIO_TRANSLAYER_DISP_CAPACITY];
}TiNioTransLayerDispatcher;
...
uintx nio_transdispa_send(TiNioTransLayerDispatcher * dispacher, uint16 addr, TiFrame * f, uint8 option);
