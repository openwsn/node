...
//#define CONFIG_TARGETBOARD_OPENNODE2012
#define CONFIG_TARGETBOARD_CC2430ZBW
...
/* Cc2430 ZigBee Workbench
 * Which is quite similar to cc2430 ZigBee Developing Kit (CC2430 ZDK). There's only
 * minor changes from the standard ZDK.
 * Contributed by Zhang Zhengqing.
 */
#ifdef CONFIG_TARGETBOARD_CC2430ZBW
  #define CONFIG_CPU_FREQUENCY 32
  #define CONFIG_CPU_FREQUENCY_32MHZ 1
#endif
...
#if (!defined(CONFIG_COMPILER_GNUC) && !defined(CONFIG_COMPILER_IAR))
typedef signed char         int8;
typedef unsigned char 	    uint8;
typedef signed short        int16; // todo?
typedef unsigned short 	    uint16; // todo?
 ...
 * @attention: If your compiler support the _Bool keyword in C99 standard, you should
 * define bool as _Bool to avoid potential bool type conflictions. But if it doesn't
 * support C99(no _Bool support), you should define bool as char. (some system also 
 * use unsigned char)
 */
