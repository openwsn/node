...
*/  
  ...
  /* Enable the TIM2 gloabal Interrupt [ÔÊÐíTIM2È«¾ÖÖÐ¶Ï]*/
/*
...
*******************************************************************************/
void delay_nus(unsigned long n)  //ÑÓÊ±n us: n>=6,×îÐ¡ÑÓÊ±µ¥Î»6us
{ 
// todo: should adjust hardware settings to guarntee the time duration is correct
  ...
  unsigned long j;
  while(n--)              // Íâ²¿¾§Õñ£º8M£»PLL£º9£»8M*9=72MHz
  {
    j=8;				  // Î¢µ÷²ÎÊý£¬±£Ö¤ÑÓÊ±µÄ¾«¶È
	while(j--);
  }
#endif  
}
...
*******************************************************************************/
void delay_nms(unsigned long n)  //ÑÓÊ±n ms
{
  while(n--)		   // Íâ²¿¾§Õñ£º8M£»PLL£º9£»8M*9=72MHz
    delay_nus(1100);   // 1msÑÓÊ±²¹³¥
}
